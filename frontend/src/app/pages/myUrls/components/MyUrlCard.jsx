    ...
    return (
        <>
            <Reorder.Item
                ...
                className='my-4 bg-[#171717] text-white group hover:bg-slate-200 hover:text-black w-full pr-4 py-2 rounded-lg flex flex-row justify-between items-center gap-1 select-none'
            >
