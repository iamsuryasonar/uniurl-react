...
function RegisterPage() {
    ...
    return (
        <>
            <div className='w-full max-w-[450px] flex justify-center items-center place-self-center py-14 m-auto relative text-black'>
                <form className='w-full flex flex-col gap-2 p-4 border-[1px] border-slate-300 rounded-xl' >
